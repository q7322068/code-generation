package com.onecoderspace.generator.util;
...
public class DateUtils {
	...
	public static void main(String[] args) {
		System.out.println(getDayStartTime("20140101"));
		System.out.println(getDayEndTime("20140101"));
		System.out.println(longToString(getDayEndTime("20140101"),"yyyy-MM-dd HH:mm:ss"));
		System.out.println(longToString(getDayStartTime("20140101"),"yyyy-MM-dd HH:mm:ss"));
		String date = "20140101";
		System.out.println(longToString(parseStringToLong(date)));
		
		System.err.println(longToString(1388550155000L,"yyyy-MM-dd HH:mm:ss"));
	}
}